...
COMMENT ON COLUMN "MEMBER".MEMBER_NAME IS '회원 성명';
...
-- 가입일 -> SYSDATE로 삽입
INSERT INTO "MEMBER" VALUES (
	'MEM02', 'QWER1234', '고길동', '870322-1234567', SYSDATE
);
...
VALUES ('MEM03', '1Q2W3E', '고영희');

-- * JDBC 에서 날짜를 입력 받았을 때 삽입하는 방법
-- '2024-10-15 12:20:30' 자바에서 이런식의 문자열이 넘어온 경우
INSERT INTO "MEMBER" VALUES (
	'MEM04', 'PASS04', '고희동', '981010-1234567', TO_DATE('2024-10-15 12:20:30', 'YYYY-MM-DD HH24:MI:SS')
);
...
--> 0으로 시작할 가능성이 있으면 CHAR, VARCHAR2와 같은 문자형을 사용.
...
VALUES (1, 'USER01', 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');

INSERT INTO USER_USED_NN
VALUES (NULL, 'USER01', 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');
-- SQL Error [1400] [23000]: 
-- ORA-01400: NULL을 ("KH_MKJ"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
-- 단, UNIQUE 제약조건이 설정된 컬럼에 NULL 값은 중복 삽입이 가능하다.
...
--	USER_ID VARCHAR2(20) CONSTRAINT USER_ID_U UNIQUE, -- 컬럼 레벨 (제약조건명 지정)
...
-- 무결성 제약 조건(KH_MKJ.USER_ID_U)에 위배됩니다
INSERT INTO USER_USED_UK
VALUES (1, NULL, 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');
...
INSERT INTO USER_USED_UK2
VALUES (2, 'USER02', 'PASS02', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');

INSERT INTO USER_USED_UK2
VALUES (3, 'USER01', 'PASS02', '신형만', '남자', '010-1234-5678', 'sin123@kh.or.kr');

INSERT INTO USER_USED_UK2
VALUES (1, 'USER01', 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');
-- SQL Error [1]  [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_MKJ.USER_ID_NAME_U)에 위배됩니다
-- 복합 키로 지정된 컬럼값 중 하나라도 다르면 위배되지 않는다.
--> 모든 컬럼의 값이 중복되면 위배 된다.
...
-- 테이블에 대한 식별자(사용자번호, 학번 ...) 역할을 한다.

-- NOT NULL + UNIQUE 제약조건의 의미 -> 중복되지 않는 값이 필수로 존재 해야한다.

-- 한 테이블 당 한 개만 설정할 수 있다.
-- 컬럼 레벨, 테이블 레벨 둘 다 설정 가능하다.
-- 한 개의 컬럼에 설정할 수도 있고, 여러 개의 컬럼을 묶어서 설정할 수 있다.
-- (== PRIMARY 복합 키)
...
CREATE TABLE USER_USED_PK(
	...
	EMAIL VARCHAR2(50)
	-- 테이블 레벨
--	CONSTRAINT USER_ID_PK PRIMARY KEY(USER_NO)
);
...
INSERT INTO USER_USED_PK
VALUES (1, 'USER02', 'PASS02', '신형만', '남자', '010-1234-5678', 'sin1234@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001:
-- 무결성 제약 조건(KH_MKJ.USER_NO_PK)에 위배됩니다
-- 기본키 중복 오류.

INSERT INTO USER_USED_PK
VALUES (NULL, 'USER03', 'PASS03', '신짱아', '여자', '010-1234-5678', 'sin1234@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: 
-- NULL을 ("KH_MKJ"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
-- 기본 키 NULL이므로 오류.

INSERT INTO USER_USED_PK
VALUES (2, 'USER03', 'PASS03', '신짱아', '여자', '010-1234-5678', 'sin1234@kh.or.kr');
...
CREATE TABLE USER_USED_PK2 (
	...
	EMAIL VARCHAR2(50),
	-- 테이블 레벨
	CONSTRAINT PK_USERNO_USERID PRIMARY KEY(USER_ID, USER_NO)
);
...
INSERT INTO USER_USED_PK2
VALUES (2, 'USER01', 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');

INSERT INTO USER_USED_PK2
VALUES (1, 'USER01', 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_MKJ.PK_USERNO_USERID)에 위배됩니다
-- USER_NO, USER_ID 둘 다 중복되었을 때만 제약조건 위배 에러 발생.

INSERT INTO USER_USED_PK2
VALUES (NULL, 'USER03', 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400:
-- NULL을 ("KH_MKJ"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2
VALUES (3, NULL, 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400:
-- NULL을 ("KH_MKJ"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_FK(
	USER_NO NUMBER PRIMARY KEY, -- 사용자 번호(고유 번호 : 중복 X , NULL X)
	USER_ID VARCHAR2(20) UNIQUE, -- 사용자 ID (중복 X)
	...
	-- 컬럼명 미작성 시 USER_GRADE 테이블의 PK를 자동으로 참조.
...
VALUES (1, 'USER01', 'PASS01', '신짱구', '남자', '010-1234-5678', 'sin123@kh.or.kr', 10);
-- USER_GRADE (부모테이블/참조테이블)에 10 이라는 GRADE_CODE 가 존재하므로 삽입 가능.

INSERT INTO USER_USED_FK
VALUES (2, 'USER02', 'PASS02', '신형만', '남자', '010-5555-5678', 'sin1234@kh.or.kr', 10);

INSERT INTO USER_USED_FK
VALUES (3, 'USER03', 'PASS03', '신짱아', '여자', '010-6666-5678', 'sin-ah123@kh.or.kr', 30);

INSERT INTO USER_USED_FK
VALUES (4, 'USER04', 'PASS04', '흰둥이', '남자', '010-7777-5678', 'hin123@kh.or.kr', null);
--> NULL 사용 가능.

INSERT INTO USER_USED_FK
VALUES (5, 'USER05', 'PASS05', '신봉선', '여자', '010-8888-5678', 'sin-bong123@kh.or.kr', 50);
-- SQL Error [2291] [23000]: ORA-02291:
-- 무결성 제약조건(KH_MKJ.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- 어떤 식으로 처리 할 지에 대한 내용을 설정할 수 있다.
...
-- 무결성 제약조건(KH_MKJ.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다

DELETE FROM USER_GRADE WHERE GRADE_CODE = 20;
-- GRADE_CODE 중 20은 외래키로 참조되고 있지 않으므로 삭제가 가능함.
SELECT * FROM USER_GRADE; -- 20 삭제 확인.
ROLLBACK; -- 되돌림. 20 돌아옴.
...
INSERT INTO USER_GRADE2 VALUES(
	10, '일반회원'
);
...
-- ON DELETE SET NULL 삭제 옵션이 적용된 자식 테이블 생성.
...
--> ON DELETE SET NULL 옵션이 설정되어 있어서 오류 없이 삭제 됨.
--> 10을 사용하고 있던 자식 레코드 값이 NULL이 됨.


-- 3) ON DELETE CASCADE : 부모 키 삭제 시 자식 키도 함께 삭제 됨.
-- 부모 키 삭제 시 값을 사용하고 있던 자식 테이블의 컬럼에 해당하는 행이 삭제 된다.
CREATE TABLE USER_GRADE3(
	GRADE_CODE NUMBER PRIMARY KEY, 
	GRADE_NAME VARCHAR2(30) NOT NULL 
);

INSERT INTO USER_GRADE3 VALUES(
	10, '일반회원'
);
...
-- ON DELETE CASCADE 삭제 옵션이 적용된 자식 테이블 생성.
...
--> ON DELETE CASCADE 옵션이 설정 되어 오류 없이 삭제 됨.
-- 부모 참조 키를 사용한 자식 행이 삭제 됨.
...
-- 체크 제약조건(KH_MKJ.GENDER_CHECK)이 위배되었습니다

INSERT INTO USER_USED_CHECK
VALUES (1, 'USER01', 'PASS01', '신짱구', '남', '010-1234-5678', 'sin123@kh.or.kr');

INSERT INTO USER_USED_CHECK
VALUES (2, 'USER02', 'PASS02', '신짱아', '여', '010-6666-5678', 'sin-ah123@kh.or.kr');

INSERT INTO USER_USED_CHECK
VALUES (3, 'USER03', 'PASS03', '신봉선', '여자', '010-8888-5678', 'sin-bong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290:
-- 체크 제약조건(KH_MKJ.GENDER_CHECK)이 위배되었습니다

--> GENDER 컬럼에 CHECK 제약조건으로 '남' 또는 '여' 만 삽입 가능하도록 설정해 둠.
...
BOARD_WRITER VARCHAR2(20) CONSTRAINT BOARD_WRITER_FK REFERENCES MEMBERS (MEMBER_ID),
